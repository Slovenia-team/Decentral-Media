...
func Content_getContent{
    ...
    assert [names + 5] = 'disliked_by'
    assert [names + 6] = 'likes'
    assert [names + 7] = 'views'
    assert [names + 8] = 'public'
    assert [names + 9] = 'created_at'
    assert [names + 10] = 'creator'
